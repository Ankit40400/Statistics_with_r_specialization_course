---
title: "statistic with data and probability with R week 3 quize"
author: "Ankit kumar"
date: "9/26/2020"
...
<li> The shortest streak is of length 1.</li> ** correct**
</ol>
...
```{r plot-sim-streaks}
 ggplot(data = sim_streak, aes(x = length)) + geom_histogram()
...
<li> Somewhat similar </li> ** correct **
...
<li> The distributions look very different. Therefore, there doesn't appear to be evidence for Kobe Bryant's hot hand. </li> ** correct **
